...
from libs.prot_utils.config import NUM_RES, NUM_EXTRA_SEQ, NUM_TEMPLATES, NUM_MSA_SEQ
from libs.prot_utils import residue_constants as rc
from libs.prot_utils.affine_utils import T
from libs.tensor_utils import (
    tree_map,
    tensor_tree_map,
    batched_gather,
)
