...
from CryoNetRefine.model.modules.transformers import AtomTransformer
from CryoNetRefine.model.modules.utils import LinearNoBias
    ...
    def forward(
        ...
        with torch.autocast("cuda", enabled=False):
            ...
            atom_feats = [
                ...
                feats["ref_element"], # shape: torch.Size([1, 1042, 128])
            ]
